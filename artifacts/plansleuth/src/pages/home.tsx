        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-in slide-in-from-bottom-8 duration-700 fade-in fill-mode-both">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-4 leading-relaxed">
              We all know it. Providers count on us not paying attention — quietly offering cheaper plans without telling us.
            </p>
            <p className="text-lg md:text-xl text-muted-foreground mb-4 leading-relaxed">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              <strong className="text-xl md:text-2xl text-primary">PlanSleuth</strong> is currently in private beta. <strong className="text-xl md:text-2xl text-primary">Join the waitlist for early access</strong> — we're opening spots in small batches.
            </p>
