...
export default function Privacy() {
  useMeta({
    ...
    description:
      "How PlanAlert collects, uses, and protects your information.",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-secondary/30">
      ...
      {/* Body — awaiting reviewed legal copy from the owner */}
      <section className="py-14 md:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-6 md:px-12 space-y-6 text-base sm:text-lg leading-relaxed text-muted-foreground">
          <p>
            ...
            here. In the meantime, if you have any questions about how
            PlanAlert handles your information, please reach out via our{" "}
