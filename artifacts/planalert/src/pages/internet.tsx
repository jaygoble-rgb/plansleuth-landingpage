...
const steps = [
  {
    ...
    body: "Enter your current ISP, monthly bill, and your address securely. It takes just two minutes.",
  },
  {
    icon: LineChart,
    number: "2",
    title: "We monitor your address",
    body: "Our system quietly checks for new fiber buildouts, 5G home internet availability, and price drops in your neighborhood.",
  },
  {
    icon: BellRing,
    number: "3",
    title: "You get plain, honest alerts",
    body: "If a genuinely better, faster, or cheaper internet deal becomes available at your home, we tell you clearly.",
  },
];
...
export default function Internet() {
  useMeta({
    ...
    canonical: canonicalUrl("/internet"),
    ogType: "website",
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
          <div className="min-w-0 animate-in fade-in slide-in-from-bottom-6 duration-700 fill-mode-both">
            ...
            <h1 className="font-serif text-[2.5rem] sm:text-5xl md:text-6xl lg:text-[4.25rem] font-bold leading-[1.07] sm:leading-[1.05] tracking-tight text-primary">
              Don't get trapped by the ISP promo cliff.
            </h1>
            <p className="mt-6 text-lg md:text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-xl">
              ISPs reserve their best prices for new customers. We quietly watch the market and tell you plainly when a better fiber or 5G deal becomes available at your address.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <Button
                ...
                data-testid="button-internet-start"
              >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-6 text-sm lg:text-base text-muted-foreground font-medium">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Not an ISP salesperson</span>
              </div>
            </div>
          </div>
             ...
             <div className="relative w-full max-w-md bg-white rounded-2xl shadow-xl shadow-primary/5 border border-[#E5EAF2] p-6 lg:p-8">
               ...
               <div className="space-y-6">
                 <div>
                   ...
                   <p className="text-sm lg:text-base text-muted-foreground mt-1">We found a faster fiber plan available at your exact address.</p>
                 </div>
                 ...
                 <div className="p-4 bg-[#F7F9FC] rounded-xl border border-[#E5EAF2]">
                   <div className="flex justify-between items-center mb-2">
                     ...
                     <span className="text-sm lg:text-base font-bold text-primary">$85/mo</span>
                   </div>
                   <div className="text-sm lg:text-base text-primary font-medium">Cable Internet 300 Mbps</div>
                 </div>
                 ...
                 <div className="p-4 bg-[#EEF2FA] rounded-xl border border-[#2563FF]/20">
                   <div className="flex justify-between items-center mb-2">
                     ...
                     <span className="text-sm lg:text-base font-bold text-primary">$50/mo</span>
                   </div>
                   <div className="text-sm lg:text-base text-primary font-medium">Symmetrical Fiber 500 Mbps</div>
                   <div className="mt-4 text-sm lg:text-base text-[#2563FF] font-semibold flex items-center gap-1.5">
                     Save $420 yearly <ArrowRight className="w-4 h-4 lg:w-5 lg:h-5" />
                   </div>
                 </div>
               </div>
             </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="order-2 md:order-1">
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-primary leading-[1.1]">
              The home internet promo cliff is real.
            </h2>
            <div className="mt-8 space-y-5 text-lg lg:text-xl text-muted-foreground leading-relaxed">
              <p>
                ISPs hook you with a highly discounted introductory rate for the first 12 months, then quietly raise your bill when the promotional period ends.
              </p>
              <p>
                Most people put their internet on autopay and forget it. In reality, <span className="font-semibold text-primary">staying put often means paying nearly double while your neighbors get faster speeds for less.</span>
              </p>
              <p>
                PlanAlert exists because you shouldn't have to constantly call retention departments to threaten to cancel. We watch your address for new fiber buildouts, 5G home internet availability, and provider pricing wars, letting you know when a move makes sense.
              </p>
            </div>
          </div>
          <div className="order-1 md:order-2 bg-[#F7F9FC] rounded-3xl p-8 lg:p-12 border border-[#E5EAF2]">
            ...
            <p className="text-muted-foreground text-lg lg:text-xl leading-relaxed mb-6">
              We are not an ISP salesperson. We don't employ pushy reps, and we aren't incentivized to trap you in an expensive bundled contract.
            </p>
            <p className="text-muted-foreground text-lg lg:text-xl leading-relaxed">
              Our only goal is to make sure you have the fast, reliable internet you need at the lowest possible cost, without the hidden fees.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-white scroll-mt-20 border-t border-[#E5EAF2]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <Button
            ...
            data-testid="button-internet-get-started-cta"
          >
