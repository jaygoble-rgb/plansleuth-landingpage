...
const steps = [
  {
    ...
    body: "Enter your carrier, current plan, and typical data usage securely. It takes just two minutes.",
  },
  {
    icon: LineChart,
    number: "2",
    title: "We monitor the market",
    body: "Our system quietly compares thousands of plans across all major networks and MVNOs, watching for price drops.",
  },
  {
    icon: BellRing,
    number: "3",
    title: "You get plain, honest alerts",
    body: "If a genuinely better equivalent plan becomes available that uses the same towers, we tell you clearly.",
  },
];
...
export default function Cellular() {
  useMeta({
    ...
    canonical: canonicalUrl("/cellular"),
    ogType: "website",
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
          <div className="min-w-0 animate-in fade-in slide-in-from-bottom-6 duration-700 fill-mode-both">
            ...
            <h1 className="font-serif text-[2.5rem] sm:text-5xl md:text-6xl lg:text-[4.25rem] font-bold leading-[1.07] sm:leading-[1.05] tracking-tight text-primary">
              Don't get trapped in an overpriced cell plan.
            </h1>
            <p className="mt-6 text-lg md:text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-xl">
              Carriers reserve their best prices for new customers. We quietly watch the entire wireless market and tell you plainly when a better deal exists for your exact usage.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <Button
                ...
                data-testid="button-cellular-start"
              >
             ...
             <div className="relative w-full max-w-md bg-white rounded-2xl shadow-xl shadow-primary/5 border border-[#E5EAF2] p-6 lg:p-8">
               ...
               <div className="space-y-6">
                 <div>
                   ...
                   <p className="text-sm lg:text-base text-muted-foreground mt-1">We found an equivalent unlimited plan on the exact same network.</p>
                 </div>
                 ...
                 <div className="p-4 bg-[#F7F9FC] rounded-xl border border-[#E5EAF2]">
                   <div className="flex justify-between items-center mb-2">
                     ...
                     <span className="text-sm lg:text-base font-bold text-primary">$90/mo</span>
                   </div>
                   <div className="text-sm lg:text-base text-primary font-medium">Unlimited Premium 5G</div>
                 </div>
                 ...
                 <div className="p-4 bg-[#EEF2FA] rounded-xl border border-[#2563FF]/20">
                   <div className="flex justify-between items-center mb-2">
                     ...
                     <span className="text-sm lg:text-base font-bold text-primary">$35/mo</span>
                   </div>
                   <div className="text-sm lg:text-base text-primary font-medium">MVNO Unlimited Value</div>
                   <div className="mt-4 text-sm lg:text-base text-[#2563FF] font-semibold flex items-center gap-1.5">
                     Save $660 yearly <ArrowRight className="w-4 h-4 lg:w-5 lg:h-5" />
                   </div>
                 </div>
               </div>
             </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="order-2 md:order-1">
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-primary leading-[1.1]">
              The wireless loyalty trap is real.
            </h2>
            <div className="mt-8 space-y-5 text-lg lg:text-xl text-muted-foreground leading-relaxed">
              <p>
                Every year, carriers introduce new plans and quietly retire old ones. They offer massive discounts, aggressive promos, and low rates—but usually only to new customers.
              </p>
              <p>
                Most people set it and forget it. They stay on the same plan, assuming their loyalty is rewarded. In reality, <span className="font-semibold text-primary">staying put often means paying double for the exact same coverage.</span>
              </p>
              <p>
                PlanAlert exists because you shouldn't have to decipher carrier pricing matrices or hunt for MVNO equivalents. We watch the wireless market and let you know if a move makes sense for your data needs.
              </p>
            </div>
          </div>
          <div className="order-1 md:order-2 bg-[#F7F9FC] rounded-3xl p-8 lg:p-12 border border-[#E5EAF2]">
            ...
            <p className="text-muted-foreground text-lg lg:text-xl leading-relaxed mb-6">
              We are not a carrier salesperson. We don't employ pushy reps, and we don't get paid to push you into expensive device payment plans. 
            </p>
            <p className="text-muted-foreground text-lg lg:text-xl leading-relaxed">
              Our only goal is to make sure you have the best possible coverage at the lowest possible cost, without the overwhelming upselling.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-white scroll-mt-20 border-t border-[#E5EAF2]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-primary mb-6 leading-[1.1]">
            Stop worrying about missing a better wireless deal
          </h2>
          ...
          <Button
            ...
            data-testid="button-cellular-get-started-cta"
          >
